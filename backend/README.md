...
- [cmd/server/main.go](/home/Hao/Game/backend/cmd/server/main.go)
...
- 迁移文件位于 [migrations](/home/Hao/Game/backend/migrations)
- 服务启动时会自动执行未应用的迁移
...
- 如需整项目的运行与发布说明，请同时查看根 [README.md](/home/Hao/Game/README.md)。

...
func TestMetadataServiceListSeriesReturnsEnrichmentErrorInsteadOfSilentEmptyState(t *testing.T) {
	...
	_, err := service.List(MetadataResource{Type: repositories.MetadataSeries, ResourceName: "series"}, true, MetadataListOptions{})
	if err == nil {
...
func TestMetadataServiceCreateDeveloperReturnsExistingBySlugWhenNameDiffers(t *testing.T) {
	...
	created, err := service.Create(
		MetadataResource{Type: repositories.MetadataDevelopers, ResourceName: "developers"},

...
func (r *GameDetailRepository) ListCovers(gameID int64) ([]domain.GameAsset, error) {
	return r.games.ListCovers(gameID)
}

func (r *GameDetailRepository) ListLogos(gameID int64) ([]domain.GameAsset, error) {
...
func (r *GameDetailRepository) ListAllAssets(gameID int64) ([]domain.GameAsset, error) {
	return r.games.ListAllAssets(gameID)
}
